...
def main():
    ...
    args.input_dir = os.path.join(current_path, "cont_segmentation")
    args.cont = os.path.join(current_path, "container_generation")
    args.mask_dir = os.path.join(current_path, "output_segmentation")

    if not os.path.exists(args.cont):
        os.makedirs(args.cont)
